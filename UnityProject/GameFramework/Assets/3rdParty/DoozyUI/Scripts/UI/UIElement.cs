...
namespace DoozyUI
{
    ...
    public class UIElement : MonoBehaviour
    {
        ...
        private GFrame.AbstractPanel _maybePanel;
        public void Reset()
        {
        ...
        void Awake()
        {
            ...
            _maybePanel = gameObject.GetComponent<GFrame.AbstractPanel>();
        ...
        void ToggleCanvasAndGraphicRaycaster(bool isEnabled)
        {
            ...
            if (!disableGraphicRaycaster)
            {
                ...
                {
                    //TODO -----!!!!
                    // bool isPanelMask = GFrame.UIMgr.S.topPanelHideMask == GFrame.PanelHideMask.UnInteractive
                    //                     || _maybePanel.hideMask == GFrame.PanelHideMask.UnInteractive;
